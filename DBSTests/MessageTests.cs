...
namespace DBSTests
{
    ...
    public class MessageTests
    {
        ...
        public void TestMessageFieldUpperBounds()
        {
            ...
            CollectionAssert.AreEqual(getChunkMsg.FileId, getChunkMsg2.FileId);
            ...
            CollectionAssert.AreEqual(chunkMsg.FileId, chunkMsg2.FileId);
            ...
            CollectionAssert.AreEqual(putChunkMsg.FileId, putChunkMsg2.FileId);
            ...
            CollectionAssert.AreEqual(storedMsg.FileId, storedMsg2.FileId);
            ...
            CollectionAssert.AreEqual(deleteMsg.FileId, deleteMsg2.FileId);
            ...
            CollectionAssert.AreEqual(removedMsg.FileId, removedMsg2.FileId);
